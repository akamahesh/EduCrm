...
@Composable
fun LeavesOptionScreen(
    navController: NavHostController,
    onOptionClick: (String) -> Unit = {},
    onUpClick: () -> Unit = {},
) {
    val optionItems = getLeaveOptions()

    LeavesOptionScreenInternal(
...
@Composable
private fun LeavesOptionScreenInternal(
...
private fun getLeaveOptions(): List<AttendanceOptionItem> {
...
private fun AttendanceScreenPreview(
    ...
    LeavesOptionScreenInternal(optionItems = optionItems)
}
