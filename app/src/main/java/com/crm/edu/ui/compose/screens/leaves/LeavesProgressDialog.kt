...
fun LeavesProgressDialog(
    ...
    Dialog(
        ...
        when (leavesDialogState) {
            is LeavesDialogState.Loading -> {
                LoadingContent()
            }

            is LeavesDialogState.Success -> {
                SuccessContent(message = leavesDialogState.message, leavesDialogState.shouldRefresh, onDismiss)
            }

            is LeavesDialogState.Error -> {
                ErrorContent(
                    message = leavesDialogState.message,
                    refresh = leavesDialogState.shouldRefresh,
                    onDismiss
                )
            }
        }
